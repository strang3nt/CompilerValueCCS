...
def compileValueCCS(
  ...
  PureCCSCompiler(ValueCCSCompiler(ccs_vp), lb, ub).mkString("\n")

object Main extends App:
  val program = scala.io.StdIn.readLine()
  val lb = scala.io.StdIn.readInt()
  val ub = scala.io.StdIn.readInt()

  println(compileValueCCS(program, lb, ub))
